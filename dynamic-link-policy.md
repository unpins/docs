...
Decide before promoting a cosmo-built package from `playground/` to top-level whether the empty import table is in the spirit of the policy. Today bash and coreutils sit in `playground/` for exactly this reason.
